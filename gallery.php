 ...
 <div class="header">
      ...
      <div class="about-us-sction">
        <div class="container">
         ...
         <img src="./gallery/1.jpg" class="img-fluid" alt="gallery" />
            </div>
          <div class="col-md-4">
          <img src="./gallery/2.jpg" class="img-fluid" alt="gallery" />
          </div>
          <div class="col-md-4">
          <img src="./gallery/3.jpg" class="img-fluid" alt="gallery" />
          </div>
          <div class="col-md-4">
          <img src="./gallery/4.jpg" class="img-fluid" alt="gallery" />
          </div>
          <div class="col-md-4">
          <img src="./gallery/5.jpg" class="img-fluid" alt="gallery" />
          </div>
          <div class="col-md-4">
          <img src="./gallery/6.jpg" class="img-fluid" alt="gallery" />
          </div>
          <div class="col-md-4">
          <img src="./gallery/7.jpg" class="img-fluid" alt="gallery" />
          </div>
          <div class="col-md-4">
          <img src="./gallery/8.jpg" class="img-fluid" alt="gallery" />
          </div>
          <div class="col-md-4">
          <img src="./gallery/9.jpg" class="img-fluid" alt="gallery" />
          </div>
